...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb-bullet">
    ...
    <li aria-current="page" class="breadcrumb-item active text-uppercase">Empleado</li>
  </ol>
</nav>
...
<div class="card mb-3 shadow">
  <div class="card-header fondo-tabla text-white">
    <h6 class="text-uppercase mb-0">Empleado | administrar</h6>
  </div>
  <div class="card-body">
    <p class="card-text">Cantidad de Empleados: {{$empleados->total()}}</p>
